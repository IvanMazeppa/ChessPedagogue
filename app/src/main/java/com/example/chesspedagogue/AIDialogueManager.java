...
public class AIDialogueManager {
    ...
    public void speakDialogueWithPersonalityAndEmotion(String speaker, String dialogue, String emotionalContext, Float currentEvaluation) {
        ...
        try {
            ...
            // Check if using ElevenLabs for enhanced emotional synthesis
            if (TTSServiceManager.isUsingElevenLabs(context)) {
                ...
                Log.d(TAG, String.format("🎭 ElevenLabs emotional TTS: %s with %s (intensity: %.2f)", 
                      speaker, emotionalResult.emotion.name, emotionalResult.intensity));
                
                elevenLabsService.speak(dialogue, new ElevenLabsTTSService.OnSpeechCompletedListener() {
                    @Override
                    public void onSpeechCompleted() {
                        emotionalCallback.onSpeechCompleted();
                    }
                });
            } else {
