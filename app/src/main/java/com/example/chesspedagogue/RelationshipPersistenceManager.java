...
public class RelationshipPersistenceManager {
    ...
    public MasterRelationship getRelationship(String master1, String master2) {
        ...
        Cursor cursor = db.rawQuery(query, new String[]{normalizedMaster1, normalizedMaster2});
    ...
    public List<String> getFatiguedTopics(String master1, String master2) {
        ...
        Cursor cursor = db.rawQuery(query, new String[]{masters[0], masters[1], String.valueOf(TOPIC_FATIGUE_THRESHOLD)});
    ...
    public List<EmotionalReaction> getEmotionalHistory(String master, String topic, int limit) {
        ...
        Cursor cursor = db.rawQuery(query, new String[]{master.toLowerCase(), topic.toLowerCase(), String.valueOf(limit)});
