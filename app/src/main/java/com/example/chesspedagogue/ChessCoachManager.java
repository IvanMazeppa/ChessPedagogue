...
// processUserInput(), startListeningForResponse(), etc.
    ...
    public GameStateInfo getCurrentGameState() {
        // Create a simple game state with default values
        String currentFen = "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1"; // Standard starting position
        List<String> moveHistory = new ArrayList<>();
        String playerColorStr = "white";

        return new GameStateInfo(currentFen, moveHistory, playerColorStr);
    }
