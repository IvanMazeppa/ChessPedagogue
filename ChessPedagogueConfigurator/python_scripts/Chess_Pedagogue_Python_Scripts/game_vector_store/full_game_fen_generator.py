...
GAMES_PER_REQUEST = 3  # Fewer games but FULL games
TOTAL_GAMES = 15  # This will give us 600-1200+ positions per master!
...
def parse_pgn_to_positions(pgn_moves: str, player_name: str, game_info: Dict[str, Any]) -> List[Dict[str, Any]]:
    """Parse PGN moves and generate FEN + annotations for every position"""
    positions = []
...
def parse_pgn_moves(pgn_moves: str) -> List[str]:
    """Extract individual moves from PGN string"""
    try:
